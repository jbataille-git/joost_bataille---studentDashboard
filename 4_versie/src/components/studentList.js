...
const StudentList = () => {
  ...
  const studentArrayList = studentArray.map((item) => {
    return (
      ...
      >
        <input
          // id="studentName" this causes trouble because it needs to be unique and used in this way, it is not
          name="studentName"
          type="checkbox"
